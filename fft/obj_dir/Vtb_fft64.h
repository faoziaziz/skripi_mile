...
#ifndef VERILATED_VTB_FFT64_H_
#define VERILATED_VTB_FFT64_H_  // guard

#include "verilated.h"

class Vtb_fft64__Syms;
class Vtb_fft64___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vtb_fft64 VL_NOT_FINAL : public VerilatedModel {
    friend class Vtb_fft64__Syms;
  private:
    // Symbol table holding complete model state (owned by this class)
    Vtb_fft64__Syms* const vlSymsp;
    // Evaluation loop
  ...
  public:
    ...
    Vtb_fft64___024root* const rootp;
    ...
    explicit Vtb_fft64(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vtb_fft64(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vtb_fft64();
  private:
    VL_UNCOPYABLE(Vtb_fft64);  ///< Copying not allowed
